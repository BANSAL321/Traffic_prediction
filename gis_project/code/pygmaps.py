...
class pygmaps:
	...
	def  drawP(self,f,paths):
		for path in paths:
			self.drawPolygon(f,path[:-1], fillColor = path[-1])
	#############################################
...
if __name__ == "__main__":
	...
	#========================================================================================
	mymap = pygmaps(12.91767311,77.62451172, 16)
	...
	# RETURN:	no return 
	#========================================================================================
	mymap.addradpoint(77.62330000,12.91770000, 95, "#FF0000")
	...
	path = [(12.91767311,77.62451172),(12.91765308,77.62513733),(12.91611576,77.62343597),(12.91627121,77.6231842),(12.91666889,77.62255859),(12.91716194,77.62245178),(12.9173336,77.62294769),(12.9175396,77.62369537)]
	#mymap.addpath(path,"#76448A")
	mymap.addpolygon(path,"#76448A")
